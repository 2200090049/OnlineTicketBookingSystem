...
public class Users {
    ...
    /**
     * Checks whether the user is currently active.
     */
    ...
    /**
     * Converts the current user into a vendor.
     */
    public void promoteToVendor(Vendor_Type type) {
        this.isVendor = true;
        this.vendorType = type != null ? type : Vendor_Type.Defualt;
        this.role = "VENDOR";
        updateTimestamp();
    }
    ...
    /**
     * Activates the user account again.
     */
    ...
    /**
     * Records a successful booking and updates
     * the user's total spending.
     */
    public void recordBooking(int bookingAmount) {
        if (bookingAmount < 0) {
